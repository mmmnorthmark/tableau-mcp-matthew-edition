...
export interface ProcessEnvWeb extends ProcessEnvBase {
  ...
  MCP_ASSET_STRATEGY: string | undefined;
  MCP_ASSET_SECRET_KEY: string | undefined;
  MCP_ASSET_CORS_ORIGINS: string | undefined;
  MCP_ASSET_STORAGE_PATH: string | undefined;
  MCP_ASSET_EXPIRATION_HOURS: string | undefined;
  OAUTH_PROVIDER: string | undefined;
  GOOGLE_CLIENT_ID: string | undefined;
  GOOGLE_CLIENT_SECRET: string | undefined;
  ALLOWED_GOOGLE_EMAILS: string | undefined;
